      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
        ...
        <div className="lg:col-span-2 z-20">
          ...
          <button
            ...
            className="inline-flex items-center mt-12 bg-blue-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:bg-gray-400"
          >
